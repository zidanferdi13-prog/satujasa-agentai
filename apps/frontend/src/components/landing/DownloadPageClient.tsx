            ...
            <CardContent sx={{ p: { xs: 3, md: 4 } }}>
              ...
              <Box component="ul" sx={{ listStyle: 'none', p: 0, m: 0 }}>
                {features.map((feature) => (
                  ...
                  >
                    <Box component="span" aria-hidden="true" className="material-symbols-outlined" sx={{ mt: 0.25, fontSize: 20, color: '#9ec7ff' }}>
                      check_circle
                    </Box>
                    {feature}
                  </Box>
        ...
        >
          {platforms.map((platform) => (
            <Card key={platform.title}>
              <CardContent sx={{ p: { xs: 3, md: 4 } }}>
                <Box component="span" aria-hidden="true" className="material-symbols-outlined" sx={{ display: 'block', fontSize: 42, color: '#6161ff', mb: 4 }}>
                  {platform.icon}
                </Box>
                ...
                <Button component={Link} href={platform.href} variant="contained" color="primary" sx={{ borderRadius: 2, px: 3 }}>
                  {platform.cta}
                </Button>
              </CardContent>
            </Card>
